...
@section('page title','MASTER DATA Jenis Properti - EDIT')
                        ...
                        <form id="formData">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jenis_properti" id="jenisProperti" value="{{ $info->name }}">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            formData.addEventListener('submit',function (e) {
                ...
                console.log();
                $.ajax({
                    url: '{{ url('admin/master-data/jenis-properti/edit-submit') }}',
                    method: 'post',
